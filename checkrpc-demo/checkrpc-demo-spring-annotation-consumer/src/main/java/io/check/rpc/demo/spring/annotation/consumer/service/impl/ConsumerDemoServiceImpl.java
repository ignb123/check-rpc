package io.check.rpc.demo.spring.annotation.consumer.service.impl;
...
public class ConsumerDemoServiceImpl implements ConsumerDemoService {
    ...
    @RpcReference(registryType = "zookeeper", registryAddress = "127.0.0.1:2181",
            loadBalanceType = "zkconsistenthash", version = "1.0.0",
            group = "check", serializationType = "protostuff", proxy = "cglib",
            timeout = 30000,async = false, oneway = false)
