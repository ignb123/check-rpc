package io.check.rpc.demo.spring.xml.provider.impl;
...
@RpcService(interfaceClass = DemoService.class, interfaceClassName = "io.check.rpc.demo.api.DemoService",
        version = "1.0.0", group = "check", weight = 2)
